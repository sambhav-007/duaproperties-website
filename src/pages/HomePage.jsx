    ...
    <>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-gray-900/30 to-gray-900/60" aria-labelledby="property-categories">
        <div className="container mx-auto px-4">
          ...
          {/* Property Categories Grid with Images */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8" role="list">
            {[
              ...
              const featuredProperty = categoryProperties[0]; // Get first property of this category
              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="block group relative overflow-hidden rounded-2xl shadow-2xl hover:shadow-[0_0_40px_rgba(193,154,107,0.4)] transition-all duration-500 hover:-translate-y-2 h-full"
                  >
                    ...
                    <div className="relative h-80 sm:h-96 overflow-hidden">
                      ...
                      <div className="absolute inset-0 p-6 flex flex-col justify-end">
                        <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2 group-hover:text-dua-accent transition-colors duration-300">
                          {category.title}
                        </h3>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2 text-dua-accent font-semibold group-hover:gap-4 transition-all duration-300">
                            <span>Explore</span>
