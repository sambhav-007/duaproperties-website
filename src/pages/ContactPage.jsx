...
function ContactPage() {
  return (
    <>
      ...
      <main className="bg-dua-primary pt-12">
        <section className="container mx-auto py-12 px-4 md:px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-white mb-10 max-w-3xl mx-auto">
            Have questions about properties in <strong>Mohali, Chandigarh, Kharar (Tricity)</strong> or <strong>Dubai, UAE</strong>? Contact Dua Property today for expert advice, sales inquiries, or property consultations. Our team is ready to guide you through local and international real estate markets.
          </p>

          <div className="max-w-xl mx-auto bg-dua-bg-light p-8 rounded-lg shadow-lg space-y-6">
            <h2 className="text-2xl font-semibold text-dua-primary mb-4">Reach Us Directly</h2>
            ...
            <p className="text-dua-body font-semibold mt-4">Serving clients across Tricity and Dubai with trusted real estate solutions.</p>

            <div className="mt-8">
              <h3 className="text-xl font-semibold text-dua-primary mb-4">Find Our Ambala Office</h3>
              <iframe
